...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
	<meta charset="utf-8" />
	<title>House for sale form</title>
			...
			<div class="row-fluid">
				...
				<div class="box-header well" data-original-title="">
					...
					<li>
                                        ...
                                        <li>
                                            <span class="divider">/</span><a href="#">Add for Sale</a>
                                        </li>
				    </ul>
                                </div>
				<div class="box-content">

				    <form class="form-horizontal" id="checkform" action="add_sale" method="post">
					<!--fieldset for personal information-->
					<div class="my_legend">Information of house<i style="color:red; font-size:13px;"> ( Note: All required fields are marked with a ' * ' )</i></div>
					<div style="border-bottom: 1px solid #e5e5e5;margin-bottom: 40px; margin-top:0px; width:44%;"></div>
						...
						<div class="controls">
						    ...
						    <span style="color:red;">*</span>
                                                ...
                                                <!--Heat:None_central_or_self field-->
					    <div class="control-group">
...
<script>
	...
	<!--<script src="js/enable_modal_manually.js"></script>	-->
        ...
        <script>alert("Please fill out all the required text boxes.");</script><%}%>
         <%if ((String) request.getAttribute("messages") == "Empty_map" ) {%>
        <script>alert("Please select location at the map");</script><%}%>
