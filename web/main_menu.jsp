<!--main menu starts-->
<!--Menu katw ap to login i' create acount-->
<div class="row-fluid">
	<div style="width: 82.87292817100001%; *width: 82.8197366816383%; margin-left:auto; margin-right:auto;">
		<div class=" navbar container-fluid" style="padding: 7px 14px;margin: 0 0 18px;list-style: none; --background-color: #0aa2f6;--&gt;
			...
			<div class="top-nav ">
				...
				<ul class="nav" >
					<li style="margin-right:50px;"><a href="about_ore.jsp">About Online Real Estate</a></li>
					<li style="margin-right:50px;"><a href="about_us.jsp">About Us</a></li>
