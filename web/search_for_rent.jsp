...
<!-- Selida anazhthshs pros enoikiash -->
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">

    <head>
	<meta charset="utf-8" />
	<title>Search for Rent</title>
			...
			<div class="row-fluid">
				...
				<div class="box-content">
					...
					<li>
                                        ...
                                        <li>
                                            <span class="divider">/</span><a href="#">Search for Rent</a>
                                        </li>
				    </ul>
                                    <div id="googleMap" style=" float:right;width:100%;height:300px;"></div>
                                </div> 
                                <form class="form-horizontal" id="checkform" action="search_rent" method="post">
					...
					<div style="border-bottom: 1px solid #e5e5e5;margin-bottom: 40px; margin-top:0px; width:44%;"></div>
						...
						<div class="controls">
						    ...
						    <span style="color:red;">(Type "none" , "central" or "autonomous")</span>
                                ...
                                <%  //to search prepei na exei ginei "ok"
                                            ...
                                            <div class="box-content">
                                                <table class="table table-striped table-bordered bootstrap-datatable datatable responsive" id="users">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <%  
                                                            //pairnw ta ids ton spitiwn me vash thn anazitisi apo to SearchRentServlet
                                                            int [] better_ids =(int[]) session.getAttribute("ids");
                                                            int counter = 0;
                                                            for(House h: HouseTableOperations.getBetterHousesRent(better_ids)){
                                                        		counter++;
							...
							%>  
								...
								<form style='display:inline' action="view_search" method="post">
								    ...
								    <%      
                                                                            //o xrhsths ploeigeitai se leptomerh perigrafh autwn
